import { Directive, EventEmitter, input, OnDestroy, Output, output } from '@angular/core';
...
@Directive({
  selector: 'mat-autocomplete[appOptionsScroll]',
})
export class OptionsScroll implements OnDestroy {

  thresholdPercent = input<number>(1);
